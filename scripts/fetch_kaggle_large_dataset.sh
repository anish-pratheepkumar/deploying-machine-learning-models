...
mkdir -p "./packages/neural_network_model/neural_network_model/datasets/v2-plant-seedlings-dataset/Purse"  && \
mv -v "./packages/neural_network_model/neural_network_model/datasets/v2-plant-seedlings-dataset/"*Shep*"/"* "./packages/neural_network_model/neural_network_model/datasets/v2-plant-seedlings-dataset/Purse"
rm -rf "./packages/neural_network_model/neural_network_model/datasets/v2-plant-seedlings-dataset/"*Shep*""